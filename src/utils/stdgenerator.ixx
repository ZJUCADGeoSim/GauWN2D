/*
    This file is adpated from https://github.com/roger-dv/cpp20-coro-generator/blob/master/generator.h
    Warning: adding member to std namespace is undefined behavior
*/
module;
#include <version>
#ifndef __cpp_impl_coroutine
#error "need coroutine"

#endif
#if __cpp_lib_generator
#include <coroutine>
#include <generator>
export module stdgenerator;
